...
private static int EVENT_ARRIVAL = 1, //Event type for arrival of a customer
				   EVENT_DEPARTURE = 2, //Event type for departure of a customer
				   EVENT_CLOSE_DOORS = 3, //Event type for closing doors at 5 PM
				   SAMPST_DELAYS = 1, //sampst variable for delays in queue(s)
...
private int   min_tellers, max_tellers, num_tellers, shortest_length, shortest_queue;
private double mean_interarrival, mean_service, length_doors_open;
...
private void depart(int teller)  /* Departure event function. */
{
...
private void jockey(int teller)  /* Jockey a customer to the end of queue "teller" from
...
/**
 * Prints a report to the out file
 */
private void report()
{
    int   teller;

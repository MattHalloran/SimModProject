...
public class SimLib {
	...
	private static int MODLUS = 2147483647;
	private static int MULT1 = 24112;
	private static int MULT2 = 26143;
	 ...
	 * @param stream
	 * @return a int with the current underlying integer for the 
	 * random-number generator for stream “stream”;
	 */
	private int lcgrandgt(int stream) {
	 ...
	 * stream is an int between 1 and 100 giving the random-number stream to be used.
	 */
	private double uniform(double a, double b, int stream) {
	 ...
	 * with mean “mean” using random-number stream “stream
	 */
	private double erlang(int m, double mean, int stream) {
	 ...
	 * @return
	 */
	private int randomInteger(float prob_distrib[], int stream) {
	 ...
	 * @param queueNum
	 */
	private void insertInQueue(Object obj, int order, int queueNum) {
